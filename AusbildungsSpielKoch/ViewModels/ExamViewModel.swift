...
//
//  Prüfungs-Logik: Timer, gemischte Fragen, Bestanden/Durchgefallen
//
...
class ExamViewModel: ObservableObject {
    ...
    func startExam() {
        // Fragen aus allen Levels im Bereich sammeln
        var pool: [Question] = []
        ...
        // Mischen und auf Prüfungsanzahl begrenzen
        pool.shuffle()
        questions = Array(pool.prefix(config.fragenAnzahl))

        // Falls nicht genug Fragen, Pool auffüllen
