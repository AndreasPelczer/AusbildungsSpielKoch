...
//
//  JSON-Parser für Lexikon-Daten (Produkte, Garmethoden, Saucen)
//
...
class LexikonLoader {
    ...
    /// Alle Kategorien aus den Produkten extrahieren (sortiert)
